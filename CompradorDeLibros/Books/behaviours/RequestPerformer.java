...
public class RequestPerformer extends Behaviour{
    ...
    case 3:      
      ...
      if (reply != null) {
         if (reply.getPerformative() == ACLMessage.INFORM) {
            System.out.println(bookTitle+" compra del agente correcta "+reply.getSender().getName());
            System.out.println("Precio = "+bestPrice);
            myAgent.doDelete();
         }
         else {
            System.out.println("Intento fallido: libro solicitado fue comprado.");
         }
  ...
  public boolean done() {
    if (step == 2 && bestSeller == null) {
       System.out.println("Intento fallido: "+bookTitle+" no disponible para comprar");
    }
